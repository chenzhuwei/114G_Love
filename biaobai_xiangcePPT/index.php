  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
			...
			con1.value='Slide';
            con2.value='One';
            con3.value='http://www.144g.com/biaobai_xiangcePPT/img/1.jpg';
            con4.value='Slide';
			con5.value='Two';
			con6.value='http://www.144g.com/biaobai_xiangcePPT/img/2.jpg';
			con7.value='Slide';
			con8.value='Three';
            con9.value='http://www.144g.com/biaobai_xiangcePPT/img/3.jpg';
            con10.value='Slide';
            con11.value='Four';
			con12.value='http://www.144g.com/biaobai_xiangcePPT/img/4.jpg';
			con13.value='Slide';
			con14.value='Five';
			con15.value='http://www.144g.com/biaobai_xiangcePPT/img/5.jpg';
			con16.value='next';
