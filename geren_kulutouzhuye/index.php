  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con2.value='骷髅头个人主页';
            con3.value='我的首页';
            con4.value='http://www.144g.com';
			con5.value='个人主页';
			con6.value='http://www.144g.com/web.php?id=Ri4rYMY';
			con7.value='在线收徒';
			con8.value='http://www.144g.com/web.php?id=Ri5LAvm';
			con9.value='个人业务';
			con10.value='http://www.144g.com/web.php?id=RiqN6HT';
			con11.value='123456';
