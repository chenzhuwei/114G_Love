  ...
  <section id="fh5co-projects">
	  ...
	  <div class="col-md-12">
        <div class="form-group">
          <div id="fh5co-subscribe">
            ...
            <input type="button" value="上传二维码" class="btn btn-primary animate-box" onclick="window.open('../tupian.php','_blank')">
          </div>
		  <span class="help-block text-center">（说明：二维码请到手机QQ获取，获取并上传后将二维码图片地址输入即可，若不会获取二维码请<a href="http://www.144g.com/plugin/go.php?url=http%3a%2f%2fjingyan.baidu.com%2farticle%2fa3a3f811f573538da2eb8a93.html" target="_blank"> 点击这里 </a>查看教程。）</span>
        </div>
      </div>
	  <div class="col-md-12">
        <div class="form-group">
	...
	<script>
        function shuru(){
            ...
            con1.value='http://p1.bqimg.com/511916/a648b5f50a8f9a14.png';
			con2.value='49553941';
			con3.value='@李白';
        }
    </script> 
